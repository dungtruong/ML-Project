...
public class Them_STKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_them__stk);
        addControls();
        addEvents();
        chonNganHang();
        chonKyHan();
    ...
    private void addEvents() {
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Them_STKActivity.this, Them_Ngan_HangActivity.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Them_STKActivity.this, STKActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void addControls() {
        ...
        txt1 = findViewById(R.id.edt_lai_suat);
        txt2 = findViewById(R.id.edt_lai_suat_k_ky_han);
        edt2 = findViewById(R.id.edt_so_tien_gui);
        spinner2 = findViewById(R.id.spinner2);
        btn3 = findViewById(R.id.btn_them_ngan_hang);
        spinner = findViewById(R.id.spinner);
        btn1 = findViewById(R.id.btn_them_tk);
        btn2 = findViewById(R.id.btn_huy_them_tk);
        edt1 = findViewById(R.id.edt_ngay_them_tk);
    ...
    private void insertSTK() {
        ...
        if (ngaygui.isEmpty() || nganhang.isEmpty() || sotiengui.isEmpty() || kyhan.isEmpty() || tralai.isEmpty() || khidenhan.isEmpty()) {
            ...
            if (so < 1000000) {
                ...
                MainActivity.database = Database.initDatabase(this, MainActivity.DATABASE_NAME);
                long kq = MainActivity.database.insert("STK", null, contentValues);
                if (kq > 0) {
                    Toast.makeText(getApplicationContext(), "Thêm Sổ Tiết Kiệm thành công", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(Them_STKActivity.this, STKActivity.class);
                    startActivity(intent);
                } else
                    Toast.makeText(getApplicationContext(), "Thêm Sổ Tiết Kiệm thất bại", Toast.LENGTH_LONG).show();
            }
        }
    }
}
